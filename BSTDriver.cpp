...
int main()
{
   ...
   //display whether the binary search tree is balanced (should not be balanced)
	cout << "Height of tree before  balance: " << bst->getHeight() << endl;
	cout << "Balance of tree before balance: ";
	if(bst->isBalanced())
		cout << "balanced" << endl;
	else
   ...
   //display whether the binary search tree is balanced (should be balanced)
	...
	cout << "Height of tree before  balance: " << min_bst->getHeight() << endl;
	cout << "Balance of tree before balance: ";
   ...
   //display whether the binary search tree is balanced (should be balanced)
	...
	cout << "Height of tree before  balance: " << complete_bst->getHeight() << endl;
	cout << "Balance of tree before balance: ";
